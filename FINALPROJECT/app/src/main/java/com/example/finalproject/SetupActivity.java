...
public class SetupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FullName = (EditText) findViewById(R.id.name_edit);

        DIY=(CheckBox) findViewById(R.id.DIY_check);
        Sport=(CheckBox) findViewById(R.id.sport_check);
        Book=(CheckBox) findViewById(R.id.book_check);
        Music=(CheckBox) findViewById(R.id.music_check);
        Food = (CheckBox) findViewById(R.id.food_check);
